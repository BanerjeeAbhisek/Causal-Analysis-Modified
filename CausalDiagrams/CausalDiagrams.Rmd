...
- $X$ causes $Y$ (e.g. Many studies suggest that eating chocolate causes weight gain)
- $X$ affects $Y$ (e.g.Various factors affect the success of a business)
- The effect of $X$ on $Y$ (e.g.The effect of social media on mental health is thought to be significant)
- $X$ influences $Y$ (e.g.The effect of diet influences overall health)
